...
export default function SecurityModule() {
  const { loading, overview, guardrails, incidents } = useSecurity();
  ...
  return (
    <Routes>
      ...
      <Route path="overview" element={<SecurityOverview overview={overview} />} />
      <Route path="guardrails" element={<Guardrails guardrails={guardrails} />} />
